sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zappleif010/zappleif010/app", ".html");
			sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

			if (sHash) {
				sHash = "#zappleif010-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
			} else {
				sHash = "#zappleif010-display";
			}

			return sUrl + sUrlParameters + sHash;
		}

		return Opa5.extend("zappleif010.zappleif010.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zappleif010/zappleif010/localService/mockserver"], function (mockserver) {
